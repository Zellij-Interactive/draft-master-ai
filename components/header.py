...
def render_header():
    ...
    st.markdown(
        ...
        <div class="header-container">
            <h1>DraftMasterAI</h1>
            <p>LoL pre-game analysis, Powered by AI to give you the competitive edge before the match begins.</p>
        </div>
        """,
        ...
        with cols[1]:
            ...
            if win_conditions:
                win_conditions_html = "".join(
                    [f"<li>{condition}</li>" for condition in win_conditions]
                )
                st.markdown(
                    f"""
                    <div class="stat-card">
        ...
        with cols[2]:
            ...
            if matchup_insights:
                ...
                favorable_count = sum(
                    ...
                    if lane in matchup_insights
                    and matchup_insights[lane].get("favorable", False)
                )
